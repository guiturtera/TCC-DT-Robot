...
A própria coleção postman tem algumas descrições sobre o que cada passo faz para sua utilização, isso tudo fundamentado no [FIWARE descomplicado](https://github.com/fabiocabrini/fiware)
